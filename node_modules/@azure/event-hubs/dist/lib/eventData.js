...
(function (EventData) {
    ...
    function fromAmqpMessage(msg) {
        ...
        if (msg.message_annotations) {
            ...
            if (msg.message_annotations[amqp_common_1.Constants.partitionKey] != undefined)
                data.partitionKey = msg.message_annotations[amqp_common_1.Constants.partitionKey];
            if (msg.message_annotations[amqp_common_1.Constants.sequenceNumber] != undefined)
                data.sequenceNumber = msg.message_annotations[amqp_common_1.Constants.sequenceNumber];
            if (msg.message_annotations[amqp_common_1.Constants.enqueuedTime] != undefined)
                data.enqueuedTimeUtc = new Date(msg.message_annotations[amqp_common_1.Constants.enqueuedTime]);
            if (msg.message_annotations[amqp_common_1.Constants.offset] != undefined)
                data.offset = msg.message_annotations[amqp_common_1.Constants.offset];
        }
        ...
        for (const prop of rhea_promise_1.messageHeader) {
            if (msg[prop] != undefined) {
                if (!data.header) {
                    data.header = {};
                }
    ...
    function toAmqpMessage(data) {
        ...
        if (data.partitionKey != undefined) {
            msg.message_annotations[amqp_common_1.Constants.partitionKey] = data.partitionKey;
        ...
        if (data.sequenceNumber != undefined) {
            msg.message_annotations[amqp_common_1.Constants.sequenceNumber] = data.sequenceNumber;
        }
        if (data.enqueuedTimeUtc != undefined) {
            msg.message_annotations[amqp_common_1.Constants.enqueuedTime] = data.enqueuedTimeUtc.getTime();
        }
        if (data.offset != undefined) {
            msg.message_annotations[amqp_common_1.Constants.offset] = data.offset;
        }
