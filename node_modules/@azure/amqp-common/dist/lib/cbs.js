        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!this.connection.isOpen()) {
                    ...
                    yield utils_1.defaultLock.acquire(this.connectionLock, () => { return this.connection.open(); });
                }
                if (!this._isCbsSenderReceiverLinkOpen()) {
                    const rxOpt = {
                        ...
                        onSessionError: (context) => {
                            ...
                            const ehError = errors_1.translate(context.session.error);
                    ...
                    this._cbsSenderReceiverLink = yield requestResponseLink_1.RequestResponseLink.create(this.connection, srOpt, rxOpt);
